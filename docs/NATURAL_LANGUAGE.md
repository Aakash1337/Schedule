...
exact versioned JSON schema and then pass an independent application validation of keys, lengths,
...
1. The browser generates a request UUID and submits the versioned prompt.
