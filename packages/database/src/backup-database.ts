...
// Installed consumers of the snapshot helpers have no repository-relative location. Repository
// scripts configure this live binding from their wrapper instead of making desktop code depend on
// a checkout layout.
export let repositoryRoot = process.cwd();

export function configureBackupRepositoryRoot(root: string): void {
