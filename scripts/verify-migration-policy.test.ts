...
describe("migration policy", () => {
  ...
  it("requires an explicit reason for destructive new SQL", async () => {
    const cases = [
      ...
      "ALTER TYPE public.customer_record DROP ATTRIBUTE obsolete;\n",
      "ALTER TYPE public.customer_record ALTER ATTRIBUTE code SET DATA TYPE text;\n",
      ...
      "DROP TRIGGER activity_events_prevent_mutation ON activity_events;\n",
      ...
      "ALTER FOREIGN TABLE external_items DROP COLUMN payload;\n",
      "ALTER FOREIGN TABLE external_items RENAME COLUMN payload TO legacy_payload;\n",
